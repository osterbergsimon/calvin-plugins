...
def _protocol_methods(plugin_type: str) -> list[str]:
    ...
    if plugin_type == "service":
        return [
            ...
            "    ) -> dict[str, Any]:",
            "        # TODO: return the data payload your display_schema binds to.",
            "        return {}",
            "",
...
def generate_plugin_py(plugin_id, name, plugin_type, description, single_instance, instance_label):
    ...
    if plugin_type == "service":
        ...
        lines += [
            ...
            "                # },",
            "            },",
            "            # TODO: pick a display_schema.kind for your dashboard UI.",
            "            # See docs/plugins/PLUGIN_FRONTEND_COMPONENTS.md for the catalog.",
            "            # Example:",
            "            # display_schema={",
            '            #     "kind": "status-tile",',
            '            #     "title": "' + name + '",',
